...
public class Relatorios {
        ...
        public static void gerarRelatorioFilmeMaisVendido() {
                ...
                System.out.println(ANSI_BLACK
                                + "\n=======================================================================");
                System.out.println(ANSI_BLACK + "|" + ANSI_BRIGHT_RED + " CINEJAVA" + ANSI_BLACK
                                + " > Relatórios                            | " + ANSI_WHITE_SNOW + " Área do Gerente"
                                + ANSI_BLACK
                                + " |");
                System.out.println(
                                ANSI_BLACK + "-----------------------------------------------------------------------\n"
        ...
        public static class FaturamentoBomboniere {
                ...
                private static Map<String, Integer> itensVendidos = new HashMap<>(); // Armazena produtos e suas
                                                                                     // quantidades
